...
output=read.table(paste0(this,".cospec.out"), head=T)
...
output$nperm_hommola=nperm_hommola
output$p_hommola=round(p_final_hommola,5)


write.table(output, paste0(this,".cospec.out"), row.names=F, sep="\t")
