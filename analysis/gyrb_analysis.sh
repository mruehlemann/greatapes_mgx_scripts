...
cat gyrb_prot_to_genome.tsv  | cut -f 5 | /work_beegfs/sukmb276/software/bin/faSomeRecords /work_beegfs/sukmb276/Metagenomes/projects/ApesComplete/output/220616_analysis_final/allgroups/protein_catalogs/GreatApes.allprot.faa /dev/stdin GreatApes.gyrb.faa
grep f__Bifidobacteriaceae gyrb_prot_to_genome.tsv | cut -f 5 | /work_beegfs/sukmb276/software/bin/faSomeRecords GreatApes.gyrb.faa /dev/stdin GreatApes.bifido.gyrb.faa
grep c__Coriobacteriia gyrb_prot_to_genome.tsv | cut -f 5 | /work_beegfs/sukmb276/software/bin/faSomeRecords GreatApes.gyrb.faa /dev/stdin GreatApes.corio.gyrb.faa
...
makeblastdb -in GreatApes.bifido.gyrb.filt+og.faa -dbtype prot
...
/work_beegfs/sukmb276/software/bin/iqtree2 -s GreatApes.bifido.gyrb.filt.aln.faa --alrt 1000 -B 1000 -m WAG -T 16
