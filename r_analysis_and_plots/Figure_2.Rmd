...
write.table(cands_res_ph %>% select(tax, ogs, H_prev, N_prev, pval, effect, Zscore, annot), "figures_and_tables/Suppl_Table_S10_Results_Human.vs.NHP_KO_Tax.tsv", row.names = F, sep="\t")
...
write.table(cands_meta_ph %>% select(ogs, Z_sum, w_sum, Z_meta, p_meta, q_meta = qval, gene, annot), "figures_and_tables/Suppl_Table_S11_Results_Human.vs.NPH_KO_Meta.tsv", row.names = F, sep="\t")
